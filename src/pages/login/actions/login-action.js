...
export const SET_USER_DATA_LOG_STATUS = "SET_USER_DATA_LOG_STATUS";
...
const setUserDataLog = (userData) => ({
  type: SET_USER_DATA_LOG_STATUS,
  userData,
})
...
export const setUserDataLogAction = (userData) => {
  return async (dispatch) => {
    dispatch(setUserDataLog(userData));
  };
};
